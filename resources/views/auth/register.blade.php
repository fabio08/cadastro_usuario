                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="salario" type="number" min="0.01" step="0.01" class="form-control @error('salario') is-invalid @enderror" name="salario" maxlength="16" value="{{ old('salario') }}" required autocomplete="salario">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefone" type="tel" placeholder="ex: 8888-8888" class="form-control @error('telefone') is-invalid @enderror" name="telefone" maxlength="14" value="{{ old('telefone') }}" required autocomplete="telefone">
